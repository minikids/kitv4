...
local function setupChestESP()
    ...
    local function updateChestBillboard(chest, billboard)
        if not chest or not billboard then return end
        ...
        if showItemsToggle and showItemsToggle.Enabled then
            ...
            layout.Padding = UDim2.fromOffset(2, 2)
            layout.Parent = frame
            ...
            if #items == 0 then
                ...
                for _, item in ipairs(items) do
                    ...
                    itemText.Text = string.format("%s x%d", item.Name, item:GetAttribute("Amount") or 1)
