					...
					if handle then
						...
						if Sway.Enabled then
							if moveSpring.Target.Magnitude > 0.1 then
								moveSpring.Target = moveSpring.Target + ((gameCamera.CFrame * CFrame.new(math.sin(tick() * 10) * 0.06, 0, 0)).Position - gameCamera.CFrame.Position)
							else
								moveSpring.Target = moveSpring.Target + ((gameCamera.CFrame * CFrame.new(0, math.sin(tick()) * 0.04, 0)).Position - gameCamera.CFrame.Position)
							end
						end
