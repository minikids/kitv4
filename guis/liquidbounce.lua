...
local getcustomassets = {
	['KitVape/assets/liquidbounce/blatant.png'] = 'rbxasset://liquidbounce/blatant.png',
	['KitVape/assets/liquidbounce/combat.png'] = 'rbxasset://liquidbounce/combat.png',
	['KitVape/assets/liquidbounce/expand.png'] = 'rbxasset://liquidbounce/expand.png',
	['KitVape/assets/liquidbounce/inventory.png'] = 'rbxasset://liquidbounce/inventory.png',
	['KitVape/assets/liquidbounce/logo.png'] = 'rbxasset://liquidbounce/logo.png',
	['KitVape/assets/liquidbounce/minigames.png'] = 'rbxasset://liquidbounce/minigames.png',
	['KitVape/assets/liquidbounce/render.png'] = 'rbxasset://liquidbounce/render.png',
	['KitVape/assets/liquidbounce/textgui.png'] = 'rbxasset://liquidbounce/textgui.png',
	['KitVape/assets/liquidbounce/utility.png'] = 'rbxasset://liquidbounce/utility.png',
	['KitVape/assets/liquidbounce/world.png'] = 'rbxasset://liquidbounce/world.png',
...
local function writeFont()
	...
	--[[writefile('KitVape/assets/liquidbounce/lbfont.json', httpService:JSONEncode({
		name = 'Inter',
		faces = {
			{style = 'normal', assetId = getcustomasset('KitVape/assets/liquidbounce/Inter-Light.ttf'), name = 'Light', weight = 300},
			{style = 'normal', assetId = getcustomasset('KitVape/assets/liquidbounce/Inter-Regular.ttf'), name = 'Regular', weight = 400},
			{style = 'normal', assetId = getcustomasset('KitVape/assets/liquidbounce/Inter-Medium.ttf'), name = 'Medium', weight = 500}
		}
	}))]]
	return getcustomasset('KitVape/assets/liquidbounce/lbfont.json')
end
...
components = {
	...
	Dropdown = function(optionsettings, children, api)
		...
		dropdownexpand.Image = getcustomasset('KitVape/assets/liquidbounce/expand.png')
...
function mainapi:CreateCategory(categorysettings)
	...
	function categoryapi:CreateModule(modulesettings)
		...
		expandicon.Image = getcustomasset('KitVape/assets/liquidbounce/expand.png')
...
mainapi:CreateCategory({
	Name = 'Combat',
	Icon = getcustomasset('KitVape/assets/liquidbounce/combat.png'),
	Size = UDim2.fromOffset(16, 15)
})
mainapi:CreateCategory({
	Name = 'Blatant',
	Icon = getcustomasset('KitVape/assets/liquidbounce/blatant.png'),
	Size = UDim2.fromOffset(15, 15)
})
mainapi:CreateCategory({
	Name = 'Render',
	Icon = getcustomasset('KitVape/assets/liquidbounce/render.png'),
	Size = UDim2.fromOffset(15, 9)
})
mainapi:CreateCategory({
	Name = 'Utility',
	Icon = getcustomasset('KitVape/assets/liquidbounce/utility.png'),
	Size = UDim2.fromOffset(15, 15)
})
mainapi:CreateCategory({
	Name = 'World',
	Icon = getcustomasset('KitVape/assets/liquidbounce/world.png'),
	Size = UDim2.fromOffset(15, 15)
})
mainapi:CreateCategory({
	Name = 'Inventory',
	Icon = getcustomasset('KitVape/assets/liquidbounce/inventory.png'),
	Size = UDim2.fromOffset(14, 15)
})
mainapi:CreateCategory({
	Name = 'Minigames',
	Icon = getcustomasset('KitVape/assets/liquidbounce/minigames.png'),
	Size = UDim2.fromOffset(15, 15)
})
