...
local getcustomassets = {
	['KitVape/assets/old/barlogo.png'] = 'rbxasset://barlogo.png',
	['KitVape/assets/old/blatanticon.png'] = 'rbxasset://blatanticon.png',
	['KitVape/assets/old/checkbox.png'] = 'rbxasset://checkbox.png',
	['KitVape/assets/old/combaticon.png'] = 'rbxasset://combaticon.png',
	['KitVape/assets/old/friendsicon.png'] = 'rbxasset://friendsicon.png',
	['KitVape/assets/old/guiicon.png'] = 'rbxasset://guiicon.png',
	['KitVape/assets/old/info.png'] = 'rbxasset://info.png',
	['KitVape/assets/old/pin.png'] = 'rbxasset://pin.png',
	['KitVape/assets/old/profilesicon.png'] = 'rbxasset://profilesicon.png',
	['KitVape/assets/old/rendericon.png'] = 'rbxasset://rendericon.png',
	['KitVape/assets/old/search.png'] = 'rbxasset://search.png',
	['KitVape/assets/old/settingsicon.png'] = 'rbxasset://settingsicon.png',
	['KitVape/assets/old/targetinfoicon.png'] = 'rbxasset://targetinfoicon.png',
	['KitVape/assets/old/textguiicon.png'] = 'rbxasset://textguiicon.png',
	['KitVape/assets/old/textv4.png'] = 'rbxasset://textv4.png',
	['KitVape/assets/old/textvape.png'] = 'rbxasset://textvape.png',
	['KitVape/assets/old/utilityicon.png'] = 'rbxasset://utilityicon.png',
	['KitVape/assets/old/vape.png'] = 'rbxassetid://14373395239',
	['KitVape/assets/old/worldicon.png'] = 'rbxasset://worldicon.png'
}
...
local function getTableSize(tab)
	local ind = 0
	for _ in tab do ind = for _ in tab do ind + (1 end)
	return ind
end
	...
	TextList = function(optionsettings, children, api)
		...
		function optionapi:ChangeValue(val)
			...
			for i, v in self.List do
				...
				objectdotin.Image = getcustomasset('KitVape/assets/old/checkbox.png')
...
function mainapi:CreateBar()
	...
	logo.Image = getcustomasset('KitVape/assets/old/barlogo.png')
	...
	settingsicon.Image = getcustomasset('KitVape/assets/old/settingsicon.png')
	...
	searchbutton.ImageLabel.Image = getcustomasset('KitVape/assets/old/search.png')
...
function mainapi:CreateOverlay(categorysettings)
	...
	pin.Image = getcustomasset('KitVape/assets/old/pin.png')
...
function mainapi:CreateNotification(title, text, duration, type)
	...
	task.delay(0, function()
		...
		iconshadow.ZIndex = 5
		iconshadow.BackgroundTransparency = 1
		iconshadow.Image = getcustomasset('KitVape/assets/old/info.png')
		iconshadow.ImageColor3 = Color3.new()
		iconshadow.ImageTransparency = 0.5
...
function mainapi:Load(skipgui, profile)
	...
	if inputService.TouchEnabled and #self.Keybind == 1 and self.Keybind[1] == 'RightShift' then
		...
		image.Image = getcustomasset('KitVape/assets/old/vape.png')
		image.Parent = button
...
function mainapi:Save(newprofile)
	...
	writefile('KitVape/profiles/'..game.GameId..'.gui.txt', httpService:JSONEncode(guidata))
	writefile('KitVape/profiles/'..self.Profile..self.Place..'.txt', httpService:JSONEncode(savedata))
end
...
mainapi:CreateCategory({
	Name = 'GUI',
	Icon = getcustomasset('KitVape/assets/old/guiicon.png')
})
local combat = mainapi:CreateCategory({
	Name = 'Combat',
	Icon = getcustomasset('KitVape/assets/old/combaticon.png')
})
mainapi:CreateCategory({
	Name = 'Blatant',
	Icon = getcustomasset('KitVape/assets/old/blatanticon.png'),
	WindowSize = 164
})
mainapi:CreateCategory({
	Name = 'Render',
	Icon = getcustomasset('KitVape/assets/old/rendericon.png'),
	WindowSize = 196
})
mainapi:CreateCategory({
	Name = 'Utility',
	Icon = getcustomasset('KitVape/assets/old/utilityicon.png'),
	WindowSize = 164
})
mainapi:CreateCategory({
	Name = 'World',
	Icon = getcustomasset('KitVape/assets/old/worldicon.png')
})
mainapi:CreateCategory({
	Name = 'Inventory',
	Icon = getcustomasset('KitVape/assets/old/worldicon.png')
...
local settingspane = mainapi:CreateCategory({
	Name = 'Settings',
	Icon = getcustomasset('KitVape/assets/old/settingsicon.png'),
	WindowSize = 166
})
...
local friendssettings = {
	Name = 'Friends',
	Icon = getcustomasset('KitVape/assets/old/friendsicon.png'),
...
mainapi:CreateCategoryList({
	Name = 'Profiles',
	Icon = getcustomasset('KitVape/assets/old/profilesicon.png'),
	...
	Function = function()
		...
		for _, v in categories do
			if v.Object.Visible then
				...
				offset = offset + (v.Object.Size.X.Offset + 6)
			end
		end
	end,
	Tooltip = 'Sorts GUI'
...
local textgui = mainapi:CreateOverlay({
	Name = 'Text GUI',
	Icon = getcustomasset('KitVape/assets/old/textguiicon.png'),
	WindowSize = 178,
	Function = function()
		mainapi:UpdateTextGUI()
	end
...
VapeLogo.Image = getcustomasset('KitVape/assets/old/textvape.png')
...
VapeLogoV4.Image = getcustomasset('KitVape/assets/old/textv4.png')
