...
if not shared.VapeDeveloper then
	...
	if commit == 'main' or (isfile('KitVape/profiles/commit.txt') and readfile('KitVape/profiles/commit.txt') or '') ~= commit then
		if commit ~= 'main' and isfile('KitVape/profiles/commit.txt') then
			shared.updated = readfile('KitVape/profiles/commit.txt')
		end
		wipeFolder('KitVape')
